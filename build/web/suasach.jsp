                ...
                <div class="col-sm-12">
                    ...
                    <form method="post"  action="sachServlet?action=xulythem" >
                        <div class="form-group">
                            <label>ID</label> 
                            <input type="text" 
                                   class="form-control" value="${sach.masach}" name="masach" placeholder="Enter id">
                        </div>
                        <div class="form-group">
                            <label>Full Name</label> 
                            <input type="text" 
                                   class="form-control" value="${sach.tensach}" name="tensach" placeholder="Enter name">
                        </div>

                        <div class="form-group">
                            <label>gia</label> 
                            <input type="text" 
                                   class="form-control" value="${sach.giasach}" name="giasach" placeholder="Enter name">
                        </div>
